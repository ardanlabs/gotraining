...
func main() {
	...
	// Create a synchronous in-memory pipe. Anything written
	// to the pipeWriter and can be read by the pipeReader.
	pipeReader, pipeWriter := io.Pipe()

	// Create a goroutine to perform the write since
	// the pipeReader will block until the pipeWriter is closed.
	go func() {
	...
	// Wait until the pipeWriter is closed, then write the
	// stream to Stdout.
