...
// http://play.golang.org/p/MqHBFmlEod
...
func accessLevel( /*variable_name [ ]type, variable_name type*/ ) {
	// Set of value of the accessLevel field to the value
	// that is passed in.
	/*
		variable_name.field_name = variable_name
	*/
}
