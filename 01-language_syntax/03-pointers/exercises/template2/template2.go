...
func main() {
	...
	accessLevel([operator]variable_name, integer_value)
...
func accessLevel(parameter_name1 [operator]type, parameter_name2 type) {
	// Set of value of the accessLevel field to the value
	// that is passed in.
	parameter_name1.field_name = parameter_name2
}
