...
// Sample program that implements 2 more features of curl. One is to send
// the output to a file, and the other is to squelch printing to Stdout.
// Unlike curl, we'll make these independent and we'll always output to
// Stdout unless silent is true.
package main
