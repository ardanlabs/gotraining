...
[Review Stack Trace](example1/example1.go) ([Go Playground](http://play.golang.org/p/A8yp-bzj1H))

[Packing](example2/example2.go) ([Go Playground](http://play.golang.org/p/SLOEngNewm))
