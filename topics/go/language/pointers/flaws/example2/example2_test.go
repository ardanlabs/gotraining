...
./example2_test.go:5:6: cannot inline BenchmarkAssignmentIndirect: unhandled op DCLTYPE
...
./example2_test.go:5:37: BenchmarkAssignmentIndirect b does not escape
./example2_test.go:12:7: BenchmarkAssignmentIndirect &i1 does not escape
./example2_test.go:12:5: BenchmarkAssignmentIndirect &X literal does not escape
./example2_test.go:17:12: BenchmarkAssignmentIndirect &X literal does not escape
