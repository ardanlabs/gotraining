...
func BenchmarkAssignmentSlicesMaps(b *testing.B) {
	type X struct {
		name string
	}
	for i := 0; i < b.N; i++ {
...
./example3_test.go:5:6: cannot inline BenchmarkAssignmentSlicesMaps: unhandled op DCLTYPE
...
./example3_test.go:5:39: BenchmarkAssignmentSlicesMaps b does not escape
./example3_test.go:10:12: BenchmarkAssignmentSlicesMaps make(map[int]*X) does not escape
./example3_test.go:14:12: BenchmarkAssignmentSlicesMaps make([]*X, 1) does not escape

goos: darwin
goarch: amd64
pkg: github.com/ardanlabs/gotraining/topics/go/language/pointers/flaws/example3
BenchmarkAssignmentSlicesMaps-8   	10000000	       131 ns/op	      32 B/op	       2 allocs/op

$ go tool pprof -alloc_space mem.out
Type: alloc_space
(pprof) list Benchmark
Total: 345.01MB
ROUTINE ======================== github.com/ardanlabs/gotraining/topics/go/language/pointers/flaws/example3.BenchmarkAssignmentSlicesMaps in /Users/bill/code/go/src/github.com/ardanlabs/gotraining/topics/go/language/pointers/flaws/example3/example3_test.go
