...
[WithDeadline](example3/example3.go) ([Go Playground](https://play.golang.org/p/f9IretBDWT))  
[WithTimeout](example4/example4.go) ([Go Playground](https://play.golang.org/p/b91hcwuZS1))  
