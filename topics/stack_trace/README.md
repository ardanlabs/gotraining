...
[Review Stack Trace](example1/example1.go) ([Go Playground](http://play.golang.org/p/dMv5Dx92dB))  
[Packing](example2/example2.go) ([Go Playground](http://play.golang.org/p/SIiN6Y2jTR))
___
